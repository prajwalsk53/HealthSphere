...
$navByRole = [
    'patient' => [
        ...
        ['icon' => 'fa-pills',           'label' => 'Prescriptions',     'href' => "$base/patient/prescriptions.php"],
    ...
    'doctor' => [
        ...
        ['icon' => 'fa-clipboard-list', 'label' => 'Prescription Orders','href' => "$base/doctor/prescription-orders.php"],
